...
Module Moduletdsupdate
    ...
    Public svcUVar As motorollaTSD2.TSDUpdater3.TSDUpdater



    Public Function svcU() As motorollaTSD2.TSDUpdater3.TSDUpdater
        If Not svcUVar Is Nothing Then
            Return svcUVar
        Else
            svcUVar = New motorollaTSD2.TSDUpdater3.TSDUpdater
