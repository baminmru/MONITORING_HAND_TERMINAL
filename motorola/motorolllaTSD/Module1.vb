...
Module Module1
    ...
    Public myLaser As Monitoring.BarcodeAPI = Nothing
...
again:
    ...
    Public Function FromDateTime(ByVal time As Date) As SYSTEMTIME
    ...
    Public Sub TimeToTerminal(ByVal d As DateTime)
       Dim st As SYSTEMTIME = FromDateTime(d)
      SetLocalTime(st)
    End Sub
    ...
    Public Function Ping() As Boolean
        ...
        Try
            ...
            Dim tzi As TimeZone.TimeZoneFunctionality.TimeZoneInformation
            tzi = TimeZoneFunctionality.GetTimeZone()
    ...
    Public Sub Main()
        ...
        End If
        If Not nostart Then
            myLaser = New Monitoring.BarcodeAPI
            If myLaser.InitReader() Then
